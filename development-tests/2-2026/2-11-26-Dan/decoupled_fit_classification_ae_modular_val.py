...
plot_auroc_curve(
   ...
   save_path="decoupled_fit_current_model_roc_curve_rep2.png",
)
# plot_auroc_curve(
#     model,
#     x_test,
#     y_test,
#     title="Decoupled Fit w/AE (Rep -2) (Paper Model) Test ROC (colored by threshold)",
#     color_by_threshold=True,
#     save_path="decoupled_fit_paper_model_roc_curve_rep2.png",
# )
