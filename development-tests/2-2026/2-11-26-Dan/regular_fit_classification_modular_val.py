...
plot_auroc_curve(
   ...
   x_test,
   y_test,
   title="Regular Fit (Current Model) Test ROC (colored by threshold)",
   color_by_threshold=True,
   save_path="regular_fit_current_model_roc_curve.png",
)
# plot_auroc_curve(
#     model,
#     x_test,
#     y_test,
#     title="Regular Fit (Paper Model) Test ROC (colored by threshold)",
#     color_by_threshold=True,
#     save_path="regular_fit_paper_model_roc_curve.png",
# )
