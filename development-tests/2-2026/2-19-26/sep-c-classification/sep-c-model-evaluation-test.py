...
if MODE == 'decoupled':
    fit_function =  model.rRT_fit if MODEL_TASK == 'regression' else model.cRT_fit
...
if MODEL_TASK == 'classification':
    ...
    plt.scatter(y_test_labels[y_common_mask], predictions.reshape(-1)[y_common_mask], color="#00fff00", alpha=0.3)
...
best_threshold = imbal.classification.optimize_metric(
