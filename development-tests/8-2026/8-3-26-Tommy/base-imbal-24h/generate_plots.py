...
def plot_true_vs_predictions(
    ...
    if ids is None:
        ...
        for value in ids.unique():
            plt.scatter(labels[ids == value], predictions[ids == value], s=size, marker=marker, label=value)
...
plot_true_vs_predictions(
    ...
    save_figure=f"{OUTPUT_PATH}/{DATA_PREFIX}{FULL_NAME}.png" if SAVE else None,
