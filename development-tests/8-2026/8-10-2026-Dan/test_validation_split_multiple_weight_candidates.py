...
MODEL_SAVE_PATH = "saved_models/balanced-fit-model-val-split-multiple-weights.keras"
...
if LOAD_SAVED_MODEL and os.path.exists(MODEL_SAVE_PATH):
    ...
    with open("saved_models/best_params_balanced_fit-val-split-multiple-weights.json", "w") as f:
        json.dump({
