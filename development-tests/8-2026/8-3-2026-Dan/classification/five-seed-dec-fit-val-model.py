...
MEDIAN_PARAMS_SAVE_PATH = "saved_models/median_params_decoupled_fit-val.json"
MULTI_SEED_RESULTS_SAVE_PATH = "saved_results/multi_seed_results_decoupled_fit-val.json"
TEMP_MODEL_DIRECTORY = "saved_models/five_seed_temp_models_decoupled_fit_val"
...
for seed in seeds:
    ...
    temporary_model_path = os.path.join(
        ...
        f"decoupled-fit-val-seed-{seed}.keras",
    )
