...
MEDIAN_PARAMS_SAVE_PATH = "saved_models/median_params_regular_fit-val-ae-rep-3.json"
MULTI_SEED_RESULTS_SAVE_PATH = "saved_results/multi_seed_results_regular_fit-val-ae-rep-3.json"
TEMP_MODEL_DIRECTORY = "saved_models/five_seed_temp_models_regular_fit_regular_fit_val_ae_rep_3"
...
for seed in seeds:
    ...
    temporary_model_path = os.path.join(
        ...
        f"regular-fit-val-ae-rep-3-seed-{seed}.keras",
    )
