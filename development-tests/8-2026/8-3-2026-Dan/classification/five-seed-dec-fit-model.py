...
MEDIAN_PARAMS_SAVE_PATH = "saved_models/median_params_decoupled_fit.json"
MULTI_SEED_RESULTS_SAVE_PATH = "saved_results/multi_seed_results_decoupled_fit.json"
...
for seed in seeds:
    ...
    temporary_model_path = os.path.join(
        ...
        f"decoupled-fit-model-seed-{seed}.keras",
    )
    ...
    # ----------------------------
    # Evaluation at cRT_fit's best decision threshold
    # ----------------------------
    if model.best_decision_threshold is not None:
