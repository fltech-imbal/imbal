...
best_param_paths = [
    ...
    "saved_models/median_params_regular_fit-val.json",
    "saved_models/median_params_regular_fit-val-ae.json",
    "saved_models/median_params_regular_fit-val-ae-rep-3.json",
    "saved_models/median_params_balanced_fit.json",
    "saved_models/median_params_balanced_fit-val.json",
    "saved_models/median_params_balanced_fit-val-ae.json",
    "saved_models/median_params_balanced_fit-val-ae-rep-3.json",
    "saved_models/median_params_decoupled_fit.json",
    "saved_models/median_params_decoupled_fit-val.json",
    "saved_models/median_params_decoupled_fit-val-ae.json",
    "saved_models/median_params_decoupled_fit-val-ae-rep-3.json",
]
