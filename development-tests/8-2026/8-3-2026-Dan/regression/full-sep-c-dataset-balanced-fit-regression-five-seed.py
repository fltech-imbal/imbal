...
MEDIAN_PARAMS_SAVE_PATH = "saved_models/median_params_balanced_fit_regression.json"
MULTI_SEED_RESULTS_SAVE_PATH = (
    "saved_results/multi_seed_results_balanced_fit_regression.json"
)
...
def evaluate_regression_model(model, x_values, y_values):
    ...
    # AORE is the equally weighted average of overall- and rare-region MAE.
    # This also avoids depending on the exact serialized metric key name.
