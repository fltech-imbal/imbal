...
MODEL_SAVE_PATH = "saved_models/decoupled-fit-model-val-split-ae-rep-3.keras"
MEDIAN_PARAMS_SAVE_PATH = "saved_models/median_params_decoupled_fit_regression_val_split_ae_rep_3.json"
MULTI_SEED_RESULTS_SAVE_PATH = "saved_results/multi_seed_results_decoupled_fit_regression_val_split_ae_rep_3.json"
TEMP_MODEL_DIRECTORY = "saved_models/five_seed_temp_models/decoupled-fit_regression-val-split-ae-rep-3"
...
def build_model(input_shape: int) -> imbal.regression.Model:
    ...
    flatten = layers.Flatten(name="representation_flatten")(hidden3)
