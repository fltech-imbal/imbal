...
model_paths = [
    ...
    "saved_models/regular-fit-model-val-split.keras",
    "saved_models/regular-fit-model-val-split-ae.keras",
    "saved_models/regular-fit-model-val-split-ae-rep-3.keras",
    "saved_models/balanced-fit-model.keras",
    "saved_models/balanced-fit-model-val-split.keras",
    "saved_models/balanced-fit-model-val-split-ae.keras",
    "saved_models/balanced-fit-model-val-split-ae-rep-3.keras",
    "saved_models/decoupled-fit-model.keras",
    "saved_models/decoupled-fit-model-val-split.keras",
    "saved_models/decoupled-fit-model-val-split-ae.keras",
    "saved_models/decoupled-fit-model-val-split-ae-rep-3.keras",
]

best_param_paths = [
    "saved_models/median_params_regular_fit_regression.json",
    "saved_models/median_params_regular_fit_regression_val_split.json",
    "saved_models/median_params_regular_fit_regression_val_split_ae.json",
    "saved_models/median_params_regular_fit_regression_val_split_ae_rep_3.json",
    "saved_models/median_params_balanced_fit_regression.json",
    "saved_models/median_params_balanced_fit_regression_val_split.json",
    "saved_models/median_params_balanced_fit_regression_val_split_ae.json",
    "saved_models/median_params_balanced_fit_regression_val_split_ae_rep_3.json",
    "saved_models/median_params_decoupled_fit_regression.json",
    "saved_models/median_params_decoupled_fit_regression_val_split.json",
    "saved_models/median_params_decoupled_fit_regression_val_split_ae.json",
    "saved_models/median_params_decoupled_fit_regression_val_split_ae_rep_3.json",
]
