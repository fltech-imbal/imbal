...
MODEL_SAVE_PATH = "saved_models/balanced-fit-val-split-model.keras"
MEDIAN_PARAMS_SAVE_PATH = "saved_models/median_params_balanced_fit_val_split.json"
MULTI_SEED_RESULTS_SAVE_PATH = "saved_results/multi_seed_results_balanced_fit_val_split.json"
TEMP_MODEL_ROOT = "saved_models/five_seed_temp_models"
TEMP_MODEL_DIRECTORY = os.path.join(TEMP_MODEL_ROOT, "balanced_fit_val_split")
...
for seed in seeds:
    ...
    temporary_model_path = os.path.join(
        ...
        f"balanced-fit-val-split-seed-{seed}.keras",
    )
