...
model_paths = [
    ...
    "saved_models/regular-fit-val-split-model.keras",
    "saved_models/regular-fit-val-split-ae-model.keras",
    "saved_models/regular-fit-val-split-ae-rep-3-model.keras",
    "saved_models/balanced-fit-model.keras",
    "saved_models/balanced-fit-val-split-model.keras",
    "saved_models/balanced-fit-val-split-ae-model.keras",
    "saved_models/balanced-fit-val-split-ae-rep-3-model.keras",
    "saved_models/decoupled-fit-model.keras",
    "saved_models/decoupled-fit-val-split-model.keras",
    "saved_models/decoupled-fit-val-split-ae-model.keras",
    "saved_models/decoupled-fit-val-split-ae-rep-3-model.keras",
]

best_param_paths = [
    "saved_models/median_params_regular_fit.json",
    "saved_models/median_params_regular_fit_val_split.json",
    "saved_models/median_params_regular_fit_val_split_ae.json",
    "saved_models/median_params_regular_fit_val_split_ae_rep_3.json",
    "saved_models/median_params_balanced_fit.json",
    "saved_models/median_params_balanced_fit_val_split.json",
    "saved_models/median_params_balanced_fit_val_split_ae.json",
    "saved_models/median_params_balanced_fit_val_split_ae_rep_3.json",
    "saved_models/median_params_decoupled_fit.json",
    "saved_models/median_params_decoupled_fit_val_split.json",
    "saved_models/median_params_decoupled_fit_val_split_ae.json",
    "saved_models/median_params_decoupled_fit_val_split_ae_rep_3.json",
]
