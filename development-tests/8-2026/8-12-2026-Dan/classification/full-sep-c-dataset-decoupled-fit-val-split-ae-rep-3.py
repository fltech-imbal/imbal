...
if LOAD_SAVED_MODEL and os.path.exists(MODEL_SAVE_PATH):
    ...
    with open("saved_models/best_params_decoupled_fit-val-ae-rep-3.json", "w") as f:
        json.dump({
...
if model.best_decision_threshold is not None:
    ...
    tss = imbal.metrics.TrueSkillStatistic(threshold=best_threshold)
    ...
    print(
        ...
        f'TSS using Best Threshold: {tss.result()[0]:.4f}\n'
    )
