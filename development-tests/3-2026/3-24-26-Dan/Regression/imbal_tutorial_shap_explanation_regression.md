...
**Full Code:** [view source code](imbal_tutorial_shap_explanation_regression.py)
...
![Small Error Prediction Results](../images/shap_regression.png)

### Large Error Prediction

![Large Error Prediction Results](../images/shap_regression_wrong_prediction.png)
