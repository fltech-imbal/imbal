...
weights = reciprocal_importance(densities, alpha=0.9)

(x_train, y_train, sw), (x_val, y_val, sw_val) =  imbal.regression.split(x_train, y_train, sample_weights=weights, seed=seed, test_size=0.2)
