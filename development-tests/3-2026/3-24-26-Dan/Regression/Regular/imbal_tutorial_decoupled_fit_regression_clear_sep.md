# Imbal Regression Tutorial (rRT Fit)

This tutorial demonstrates how to train a regression model using Imbal with a decoupled training strategy via the `rRT_fit` function.

### Files Needed

**Full Code:** [view source code](./imbal_tutorial_decoupled_fit_regression_clear_sep.py)
...
* **rRT_fit** applies a decoupled training strategy that leverages density information to better handle imbalanced targets.
...
![Model Results](../../images/decoupled_fit_regression.png)
...
![Model Results](../../images/decoupled_fit_regression_visualizer.png)
...
![Model Results](../../images/decoupled_fit_custom_alpha_regression.png)

![Model Results](../../images/decoupled_fit_custom_alpha_regression_visualizer.png)
