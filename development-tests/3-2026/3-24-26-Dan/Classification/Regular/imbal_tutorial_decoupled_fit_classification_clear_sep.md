...
**Full Code:** [view source code](./imbal_tutorial_decoupled_fit_classification_clear_sep.py)

**Train/Test Files**: [training data](../sep_model_training_classification.csv), [testing data](..s/sep_model_testing_classification.csv)
...
![Model Results](../../images/decoupled_fit_classification_class_weights.png)
