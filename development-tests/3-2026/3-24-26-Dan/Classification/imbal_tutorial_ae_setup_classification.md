...
### Initial Steps for Imbal Classification Tutorials w/ AE

This code is the base for each of the classification tutorials that use the autoencoder feature. Start here before continuing with any tutorial.
...
* A **Flatten layer** is added before the output.
