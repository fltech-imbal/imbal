...
**Full Code:** [view source code](imbal_tutorial_shap_explanation_classification.py)
...
![Model Results](../images/shap_classification.png)

### Incorrect Prediction

![Incorrect Prediction Results](../images/shap_classification_wrong_prediction.png)
