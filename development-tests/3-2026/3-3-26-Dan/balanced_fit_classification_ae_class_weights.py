...
monitor_metric = "val_output_layer_f1_score"
...
for cand_name, summary in cv_by_candidate.items():
    ...
    cv_results.append({
        ...
        "val_f1_score": avg.get("val_output_layer_f1_score"),
        "val_auroc": avg.get("val_output_layer_auroc"),
        "val_fp": avg.get("val_output_layer_fp"),
        "val_fn": avg.get("val_output_layer_fn"),
    })
