...
def build_model(input_shape: int) -> imbal.classification.Model:
    ...
    hidden1 = layers.Dense(32, activation="relu", name="hidden_layer1")(inputs)
    hidden2 = layers.Dense(24, activation="relu", name="hidden_layer2")(hidden1)
...
MODEL_SAVE_PATH = "saved_models/larger-model-decoupled-fit-model-val.keras"
...
if model.best_decision_threshold is not None:
    ...
    imbal.classification.plot_confusion_matrix(y_test, test_predictions, square_font_size=16)
