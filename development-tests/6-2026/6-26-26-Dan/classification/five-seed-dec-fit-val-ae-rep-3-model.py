...
BEST_PARAMS_SAVE_PATH = "saved_models/best_params_decoupled_fit-val-ae-rep-3.json"
...
if best_model is not None:
    ...
    with open(BEST_PARAMS_SAVE_PATH, "w") as f:
        json.dump({
            "best_weight_index": int(best_params["best_weight_index"]),
            "best_class_weights": [float(x) for x in best_params["best_class_weights"]],
            "best_decision_threshold": (
