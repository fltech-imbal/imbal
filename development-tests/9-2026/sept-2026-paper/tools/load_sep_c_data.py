...
def load_sep_c_data(path_prefix):
    ...
    training_labels = training_data.pop("ln_peak_intensity")
    val_labels = val_data.pop("ln_peak_intensity")
    test_labels = test_data.pop("ln_peak_intensity")
