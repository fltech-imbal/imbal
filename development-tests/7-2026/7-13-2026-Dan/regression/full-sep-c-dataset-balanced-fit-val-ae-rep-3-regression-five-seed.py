...
MULTI_SEED_RESULTS_SAVE_PATH = (
    "saved_results/multi_seed_results_balanced_fit_regression-val-ae-rep-3.json"
)
...
for seed in seeds:
    ...
    # Make fresh copies because split() replaces the training arrays locally.
    ...
    if isinstance(results, dict):
        ...
        overall_mae = float(results.get("mae"))
    else:
...
median_model = trained_models[median_seed]
