...
# Data
# ----------------------------
train_data = pd.read_csv("../../../tutorials/data/SEP-C/sep_model_training_regression.csv")
test_data  = pd.read_csv("../../../tutorials/data/SEP-C/sep_model_testing_regression.csv")
