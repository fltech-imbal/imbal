...
if LOAD_SAVED_MODEL and os.path.exists(MODEL_SAVE_PATH):
    ...
    # Validation Set
    # ----------------------------
    (x_train, y_train), (x_val, y_val) =  imbal.regression.split(x_train, y_train, test_size=0.2, seed=seed)
    ...
    with open("saved_models/best_params_regular_fit_regression-val-ae.json", "w") as f:
        json.dump({
            "best_alpha_index": -1,
            "best_alpha": -1
        }, f, indent=4)
