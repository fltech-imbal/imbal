...
def build_concurrent_representation_model(input_count):
    ...
    The density-aware branch is optimized with reciprocal-importance sample weights.
...
def create_concurrent_sample_weights(
    regression_targets,
    reciprocal_alpha,
):
...
def run_concurrent_two_latent_sep_ec_reciprocal_training(seed=42):
...
if __name__ == "__main__":
    final_model = run_concurrent_two_latent_sep_ec_reciprocal_training(seed=42)
