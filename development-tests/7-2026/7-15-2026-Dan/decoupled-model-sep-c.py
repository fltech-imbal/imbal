...
def build_stage2_regressor(stage1_model, trainable_encoder=False):
    ...
    return keras.Model(
        model_inputs,
        regression_output,
        name="stage2_weight_scanned_regressor",
    )
...
def run_two_stage_decoupled_training(seed=42):
    ...
    # Stage 2: freeze the Stage 1 encoder and scan tail weights.
...
if __name__ == "__main__":
    final_model = run_two_stage_decoupled_training(seed=42)
