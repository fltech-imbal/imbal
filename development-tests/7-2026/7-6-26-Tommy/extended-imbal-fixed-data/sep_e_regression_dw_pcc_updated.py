...
def loss_fn(y_true, y_pred):
    return keras.losses.mean_squared_error(y_true, y_pred) + 0.01*pcc(y_true, y_pred)
...
imbal.regression.plot_true_vs_predictions(
    ...
    save_figure=f"results/{DATA_PATH}_{FIT.name.lower()}_{'w' if VALIDATION_DATA or AE else ''}{'_validation' if VALIDATION_DATA else ''}{'_ae' if AE else ''}{'_third_last' if AE_THIRD_TO_LAST and AE else ''}_denseweight_pcc.png"
)