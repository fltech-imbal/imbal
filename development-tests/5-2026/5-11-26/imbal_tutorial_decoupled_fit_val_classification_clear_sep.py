...
# Data
# ----------------------------
train_data = pd.read_csv("../../../tutorials/data/SEP-C/sep_model_training_classification.csv")
test_data  = pd.read_csv("../../../tutorials/data/SEP-C/sep_model_testing_classification.csv")
