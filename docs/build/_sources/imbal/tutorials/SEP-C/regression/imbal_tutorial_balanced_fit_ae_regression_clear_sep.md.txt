# Imbal Balanced Regression Tutorial (Autoencoder + Balanced Fit)

This tutorial demonstrates how to train a neural network for a regression task while addressing class imbalance using density-based sample weighting and the `balanced_fit` function with the **autoencoder feature** enabled.

### Files Needed

**Full Code:** [view source code](../../../../../../tutorials/SEP-C/regression/imbal_tutorial_balanced_fit_ae_regression_clear_sep.py)
...
## 1. Calculate Sample Densities / Weights
...
This code uses the **autoencoder feature** during compilation:
...
```text
24/24 ━━━━━━━━━━━━━━━━━━━━ 0s 1ms/step - loss: 3.5977 - mae: 1.1151  
Test Loss: 3.5977
Test MAE: 1.1151
Common sample MAE (< ln(10)): 1.1064
Rare sample MAE (>= ln(10)): 1.5495
```
...
![Model Results](../../../../_static/tutorials/SEP-C/balanced_fit_ae_regression_visualizer.png)
...
```text
24/24 ━━━━━━━━━━━━━━━━━━━━ 0s 1ms/step - loss: 3.1353 - mae: 1.1546  
Test Loss: 3.1353
Test MAE: 1.1546
Common sample MAE (< ln(10)): 1.1480
Rare sample MAE (>= ln(10)): 1.4830
```

![Model Results](../../../../_static/tutorials/SEP-C/balanced_fit_ae_custom_alpha_regression_visualizer.png)
