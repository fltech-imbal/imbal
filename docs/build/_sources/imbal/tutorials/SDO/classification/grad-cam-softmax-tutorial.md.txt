# Grad-CAM Softmax Classification Explanations

This tutorial demonstrates how to generate Grad-CAM explanations for a softmax classification model trained on the SDO benchmark dataset.
...
## Correct not M- nor X-class Prediction
...
![Correct not M- nor X-class prediction](../../../../_static/tutorials/SDO/grad-cam-classification-softmax-actual-not-m-nor-x-class-correct.png)

## Incorrect M-class Prediction
...
![Incorrect M-class prediction](../../../../_static/tutorials/SDO/grad-cam-classification-softmax-actual-m-class-incorrect.png)

## Correct X-class Prediction
...
![Correct X-class prediction](../../../../_static/tutorials/SDO/grad-cam-classification-softmax-actual-x-class-correct.png)
