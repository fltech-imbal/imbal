# Regular Regression on SDOBenchmark with Autoencoder

## Necessary Files

- All the source code in this tutorial can be found at `imbal/tutorials/SDO/regression/sdo_regular_fit_ae.py`
...
MAE for log10 flux < -4: 1.338
MAE for log10 flux >= -4: 3.043
```

<div style="display: flex; gap: 8px; max-width: 100%;">
<img style="flex:1; max-width: 49%;" src="../../../../_static/tutorials/SDO/sample-sdo-regular-fit-ae-data-distribution.png"/>
<img style="flex:1; max-width: 49%;" src="../../../../_static/tutorials/SDO/sample-sdo-regular-fit-ae-label-vs-prediction-plot.png"/>
</div>
