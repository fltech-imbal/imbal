...
imbal.classification.lime_explain_tabular_sample(
    ...
    figure_save_path="../../../docs/source/imbal/tutorials/SEP-C/classification/lime-explanation.html"
)
...
imbal.classification.lime_explain_tabular_sample(
    ...
    class_names=['Common', 'Rare'],
    feature_names=labels,
    figure_save_path="../../../docs/source/imbal/tutorials/SEP-C/classification/lime-explanation-wrong.html"
)
