# Grad-CAM Binary Classification Explanations

This tutorial demonstrates how to generate Grad-CAM explanations for a binary classification model trained on the SDO benchmark dataset.
...
def load_sdo_data(data_path):
    ...
    for i in range(len(loaded_data_fluxes)):
        ...
        image_list = Image.open(
            os.path.join(data_path, f'sdo_subset_sample_{i}.jpg')
        ).convert('L')
        stacked_images = np.array(image_list).reshape(128, 128, 1)
        loaded_images[i] = stacked_images / 255.0
...
![True Positive prediction](../../../../_static/tutorials/SDO/grad-cam-classification-binary-true-positive.png)
...
![False Positive prediction](../../../../_static/tutorials/SDO/grad-cam-classification-binary-false-positive.png)
...
![True Negative prediction](../../../../_static/tutorials/SDO/grad-cam-classification-binary-true-negative.png)
...
![False Negative prediction](../../../../_static/tutorials/SDO/grad-cam-classification-binary-false-negative.png)
