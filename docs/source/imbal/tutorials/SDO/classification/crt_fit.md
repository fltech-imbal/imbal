...
- All the source code in this tutorial can be found at `imbal/tutorials/SDO/sdo_classification_crt_fit.py`
...
<img style="flex:1; max-width: 49%;" src="../../../_static/tutorials/SDO/sample-sdo-crt-fit-confusion-matrix-training.png"/>
<img style="flex:1; max-width: 49%;" src="../../../_static/tutorials/SDO/sample-sdo-crt-fit-confusion-matrix-test.png"/>
</div>
