...
- All the source code in this tutorial can be found at `imbal/tutorials/SDO/classification/sdo_regular_fit.py`
...
if model.best_metric_threshold is not None:
    ...
    imbal.classification.plot_confusion_matrix(
        y_test,
        test_predictions,
        save_figure='sample-sdo-regular-fit-confusion-matrix-threshold.png'
    )
```
...
19/19 ━━━━━━━━━━━━━━━━━━━━ 0s 9ms/step - accuracy: 0.9767 - f1_score: 0.0000e+00 - loss: 0.1300
...
<img style="flex:1; max-width: 49%;" src="../../../../_static/tutorials/SDO/sample-sdo-regular-fit-confusion-matrix.png"/>
<img style="flex:1; max-width: 49%;" src="../../../../_static/tutorials/SDO/sample-sdo-regular-fit-roc.png"/>
</div>
