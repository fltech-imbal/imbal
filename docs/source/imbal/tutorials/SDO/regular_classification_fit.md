# Regular Classification on SDOBenchmark

## Necessary Files

- All the source code in this tutorial can be found at `imbal/tutorials/SDO/sdo_classification_regular_fit.py`
...
## 5. Accuracy and Results Visualization
...
Overall train accuracy: 99.2%
Frequent train accuracy: 100.0%
Rare train accuracy: 0.0%
Overall test accuracy: 98.0%
Frequent test accuracy: 100.0%
Rare test accuracy: 0.0%
```

<div style="display: flex; gap: 8px; max-width: 100%;">
<img style="flex:1; max-width: 49%;" src="../../../_static/tutorials/SDO/sample-sdo-regular-fit-confusion-matrix-training.png"/>
<img style="flex:1; max-width: 49%;" src="../../../_static/tutorials/SDO/sample-sdo-regular-fit-confusion-matrix-test.png"/>
</div>
