# rRT Regression with Autoencoder on SDOBenchmark

## Necessary Files

- All the source code in this tutorial can be found at `imbal/tutorials/SDO/AE/sdo_regression_rrt_fit.py`
...
Overall train MAE: 1.262
Frequent train MAE: 1.258
Rare train MAE: 1.638
Overall test MAE: 1.006
Frequent test MAE: 0.992
Rare test MAE: 1.819
```
