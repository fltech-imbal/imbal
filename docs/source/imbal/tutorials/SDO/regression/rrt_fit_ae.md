# rRT Regression on SDOBenchmark with Autoencoder

## Necessary Files

- All the source code in this tutorial can be found at `imbal/tutorials/SDO/regression/sdo_rrt_fit_ae.py`
...
imbal.regression.plot_kde_1d(
    ...
    save_figure='sample-sdo-rrt-fit-ae-data-distribution.png'
)

imbal.regression.plot_true_vs_predictions(
    y_test,
    test_predictions,
    save_figure='sample-sdo-rrt-fit-ae-label-vs-prediction-plot.png'
)
```
...
19/19 ━━━━━━━━━━━━━━━━━━━━ 0s 11ms/step
MAE for log10 flux < -4: 1.035
MAE for log10 flux >= -4: 1.935
```

<div style="display: flex; gap: 8px; max-width: 100%;">
<img style="flex:1; max-width: 49%;" src="../../../../_static/tutorials/SDO/sample-sdo-rrt-fit-ae-data-distribution.png"/>
<img style="flex:1; max-width: 49%;" src="../../../../_static/tutorials/SDO/sample-sdo-rrt-fit-ae-label-vs-prediction-plot.png"/>
</div>
...
Number of test samples with log10 flux >= -4: 14
19/19 ━━━━━━━━━━━━━━━━━━━━ 0s 13ms/step
MAE for log10 flux < -4: 1.077
MAE for log10 flux >= -4: 2.161
```

<div style="display: flex; gap: 8px; max-width: 100%;">
<img style="flex:1; max-width: 49%;" src="../../../../_static/tutorials/SDO/sample-sdo-rrt-fit-ae-data-distribution-alphas.png"/>
<img style="flex:1; max-width: 49%;" src="../../../../_static/tutorials/SDO/sample-sdo-rrt-fit-ae-label-vs-prediction-plot-alphas.png"/>
</div>
