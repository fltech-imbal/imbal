# Balanced Regression on SDOBenchmark with Autoencoder

## Necessary Files

- All the source code in this tutorial can be found at `imbal/tutorials/SDO/regression/sdo_balanced_fit_ae.py`
...
19/19 ━━━━━━━━━━━━━━━━━━━━ 0s 13ms/step
MAE for log10 flux < -4: 1.037
MAE for log10 flux >= -4: 2.012
```
...
Number of test samples with log10 flux >= -4: 14
19/19 ━━━━━━━━━━━━━━━━━━━━ 0s 12ms/step
MAE for log10 flux < -4: 1.129
MAE for log10 flux >= -4: 2.267
```
