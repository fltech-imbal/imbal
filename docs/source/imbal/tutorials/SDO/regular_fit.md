# Standard Regression on Imbalanced Image Data

The purpose of this tutorial is to outline the necessary steps
to perform a standard regression model training and evaluation
...
imbal.regression.plot_kde_1d(
    ...
    save_figure='sample-sdo-standard-fit-data-distribution.png'
)
...
plot_true_vs_predictions(
    y_test,
    test_predictions,
    save_figure='sample-sdo-standard-fit-label-vs-prediction-plot.png'
)
```
...
Number of rare testing samples: 3
4/4 ━━━━━━━━━━━━━━━━━━━━ 1s 136ms/step
4/4 ━━━━━━━━━━━━━━━━━━━━ 1s 106ms/step
Overall train MAE: 0.888
Rare train MAE: nan
Overall test MAE: 0.984
Rare test MAE: 2.111
```

<div style="display: flex; gap: 8px; max-width: 100%;">
<img style="flex:1; max-width: 49%;" src="../../../_static/tutorials/SDO/sample-sdo-standard-fit-data-distribution.png"/>
<img style="flex:1; max-width: 49%;" src="../../../_static/tutorials/SDO/sample-sdo-standard-fit-label-vs-prediction-plot.png"/>
</div>
