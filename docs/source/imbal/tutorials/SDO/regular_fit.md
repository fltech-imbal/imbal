...
- All the source code in this tutorial can be found at `imbal/tutorials/SDO/sdo_regression_regular_fit.py`
...
Overall train MAE: 1.248
Frequent train MAE: 1.237
Rare train MAE: 2.967
Overall test MAE: 1.342
Frequent test MAE: 1.307
Rare test MAE: 3.368
```
