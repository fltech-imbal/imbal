# Balanced Regression with Autoencoder on SDOBenchmark

## Necessary Files

- All the source code in this tutorial can be found at `imbal/tutorials/SDO/AE/sdo_regression_balanced_fit.py`
...
Overall train MAE: 1.268
Frequent train MAE: 1.265
Rare train MAE: 1.840
Overall test MAE: 1.042
Frequent test MAE: 1.031
Rare test MAE: 1.812
```
