...
imbal.regression.lime_explain_tabular_sample(
    ...
    figure_save_path="../../../docs/source/imbal/tutorials/SEP-C/regression/lime-explanation.html"
)
...
imbal.regression.lime_explain_tabular_sample(
    ...
    actual_label=np.round(float(y_test.reshape(-1)[target_sample_index]), 4),
    feature_names=labels,
    figure_save_path="../../../docs/source/imbal/tutorials/SEP-C/regression/lime-explanation-wrong.html"
)
