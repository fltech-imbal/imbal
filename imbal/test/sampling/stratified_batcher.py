...
class TestStratifiedBatcher(unittest.TestCase):
    def test_preserve_weights_on_sparse_data(self) -> None:
        ...
        batcher = backend.DatasetWithBatching(data, labels, num_batches=4, sample_weights=weights, mode=ModelType.CLASSIFICATION)
    ...
    def test_preserve_data_label_weight_association_regression(self) -> None:
        ...
        batcher = backend.DatasetWithBatching(data, labels, batch_size=64, sample_weights=weights, mode=ModelType.REGRESSION)
    ...
    def test_simple_case_1(self) -> None:
        ...
        sampler_1 = backend.DatasetWithBatching(data, labels, num_batches=2, mode=ModelType.CLASSIFICATION)
    ...
    def test_simple_case_2(self) -> None:
        ...
        sampler_2 = backend.DatasetWithBatching(data, labels, num_batches=2, sample_weights=weights, mode=ModelType.CLASSIFICATION)
    ...
    def test_simple_case_3(self) -> None:
        ...
        sampler_3 = backend.DatasetWithBatching(data, labels, num_batches=3, sample_weights=weights, mode=ModelType.REGRESSION)
