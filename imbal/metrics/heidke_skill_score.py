...
class HeidkeSkillScore(ConfusionMatrixMetric):
    ...
    .. code-block:: python
        ...
        metric = imbal.metrics.HeidkeSkillScore(threshold=0.5)
    ...
    * :code:`"HeidkeSkillScore"`
    * :code:`"heidke_skill_score"`
    * :code:`"hss"`
    * :code:`"HSS"`
    ...
    **Note:** Where appropriate, documentation for functions from :code:`tf.keras.Metric` has been
    ...
    Args:
        ...
        name : Optional, default :code:`"heidke_skill_score"`. String name
    ...
    def result(self) -> Tensor:
        ...
        Returns:
            The Heidke skill score of the accumulated data.
        """
